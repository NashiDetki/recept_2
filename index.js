let card__1 = document.querySelector(".card__item1")
let card__2 = document.querySelector(".card__item2")
let card__3 = document.querySelector(".card__item3")
 console.log(card__1)
// console.log("card__item2")
// console.log("card__item3")
...
const titleCard_1 = card__1.querySelector(".card__title");
const titleCard_2 = card__2.querySelector(".card__title");
const titleCard_3 = card__3.querySelector(".card__title");
console.log(titleCard_1);
console.log(titleCard_2);
console.log(titleCard_3);
 
// popup.classList.and("popup__opened")
// popup.classList.contain("popup__opened")

// function setHello(name){
//     let greating = 'hello Ivan' + name
//     return greating;
    
// }
// console.log("setHello" ('николай'));
